            ...
            <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <Link to="/" className="font-extrabold text-2xl tracking-tighter text-slate-900 flex items-center gap-1 group">
                        <img src="/assets/ongole_logo.png" className="w-8 h-8 object-contain group-hover:scale-105 transition-transform duration-200" alt="Ongole Logo" />
                        <span className="group-hover:text-slate-700 transition-colors">Ongole</span>
                    </Link>
