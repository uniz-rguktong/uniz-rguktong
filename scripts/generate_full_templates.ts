...
async function generate() {
    const userPrisma = new PrismaClient({ datasourceUrl: process.env.DATABASE_URL_USER });
    const academicPrisma = new PrismaClient({ datasourceUrl: process.env.DATABASE_URL_ACADEMIC });
